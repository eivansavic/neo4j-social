...
bearerToken = os.environ.get(
    'TWITTER_BEARER', "AAAAAAAAAAAAAAAAAAAAAEH04QAAAAAA6RFhHaG2La%2B9JqqT7knBdDXOj6o%3DphvxAFrcGeJlPG0ycoXrrwkJ0Pqx654yubqnSx4XdDAkp55b5x")
...
q = urllib.quote_plus(os.environ.get(
    "TWITTER_SEARCH", 'neo4j OR java OR python OR golang OR #java OR #spring OR #neo4j'))
